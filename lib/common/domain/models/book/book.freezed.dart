...
class _$_Book extends _Book {
  const _$_Book(
      {this.uid, this.name, this.authorId, this.categories, this.imageUrl})
      : super._();
  ...
  @override
  String toString() {
    return 'Book(uid: $uid, name: $name, authorId: $authorId, categories: $categories, imageUrl: $imageUrl)';
  }
