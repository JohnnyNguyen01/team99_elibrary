  ...
  Widget build(BuildContext context) => Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            /* -------------------------------------------- To see the Get Help 
            Page, 
            backspace this and the line at the bottom of this code. 
            Make sure to comment out the single child scroll view
...
Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                "To log in to our library system, you must login with your student ID email. Please view the image to see formatting.",
                style: TextStyle(fontSize: 15),
              ),
              SizedBox(height: 30),
              Text(
              ...
              Text(
                "No. This system is reserved for WSU Students and Staff members. You may arrive to our library in-person and read books, however borrowing is restricted to our students and staff.",
                style: TextStyle(fontSize: 15),
              ),
              SizedBox(height: 30),
              Text(
                "I would like to reference a book from this library website. How?",
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
              ),
              Row(
                children: [
                  ...
                  Text(' Referencing ',
                      style:
                          TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                  Text(
                    "page. This page has extensive guides on various referencing methods for our many PDFs.",
                    style: TextStyle(fontSize: 15),
                  ),
                ],
              ),
              ...
              /*InkWell(
                  child: Text('test'),
                  onTap: () => launch('https://i.imgur.com/pEAjsDy.png'),
                ),*/
              Text(
                "If the FAQ Questions have not answered your queries, there are other avenues we have where you can get help. You can:",
                style: TextStyle(fontSize: 15),
              ),
              Text(
                "- Talk to one of our librarians through our live chat system",
